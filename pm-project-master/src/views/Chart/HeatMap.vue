...
export default {
  ...
  methods: {
    async getHeatMapInfo(data) {
      ...
      await postJSON('/chart/getHeatMapInfo', {
        id: data.type === 'source' ? data.groupId : data.fileId,
        sampleProperty: data.type,
        sampleType: data.heatMapType,
    ...
    async drawHeatMap(data) {
      ...
      this.heatMap.setOption({
        ...
        grid: {
          left: '4%', right: '0%', bottom: '10px', top: '10px', containLabel: true,
        },
      });
    }
  }
